  ...
  <header class="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-neutral-200 bg-white px-4 sm:px-6">
    ...
    <div class="flex items-center gap-2">
      <!-- Same tab, not target="_blank" — on mobile Chrome/Safari, a
           ...
           worked fine. Hidden for a platform Super Admin browsing no
           particular school, who has no one website to link to. -->
      <BaseButton v-if="websiteUrl" :href="websiteUrl" variant="outline" size="sm">
